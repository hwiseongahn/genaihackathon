...
const SpeechToText = ({startListening, isListening, stopListening, textArray, createGeminiRequest}) => {
  return (
        ...
        <div className="card">
          <div className="card-body">
            ...
            <p className="text-muted text-center">
              Simply speak out the tasks that are stressing you out and see the
              magic happen!
            </p>
